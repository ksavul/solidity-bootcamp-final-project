...
export interface NFTPicachuInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface NFTPicachu extends BaseContract {
  connect(runner?: ContractRunner | null): NFTPicachu;
  waitForDeployment(): Promise<this>;

  interface: NFTPicachuInterface;
